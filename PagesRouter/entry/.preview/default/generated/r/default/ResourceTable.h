...
const int32_t STRING_BACK = 0x01000004;
const int32_t STRING_MODULE_DESC = 0x01000005;
const int32_t STRING_NEXT = 0x01000006;
const int32_t COLOR_BUTTON_BG = 0x01000008;
const int32_t COLOR_PAGE_BG = 0x01000009;
